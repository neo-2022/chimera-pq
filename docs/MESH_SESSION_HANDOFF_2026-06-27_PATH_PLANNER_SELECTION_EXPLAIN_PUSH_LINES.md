# CHIMERA Mesh Session Handoff: Path Planner Selection Explain Push Lines
...
- Reworked the path-planner selection explain tail to use direct helper pushes
  instead of repeated `format!` calls.
...
- `path_planner_candidate_snapshot_ops_per_sec=7404`
- `path_planner_candidate_snapshot_p95_ns=136271`
- `live_dps_plan_path_from_payload_ops_per_sec=3568`
- `live_dps_plan_path_from_payload_p95_ns=292025`
- `status_explain_ops_per_sec=17704`
- `status_explain_p95_ns=58420`
