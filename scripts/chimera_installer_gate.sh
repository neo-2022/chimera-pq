...
rg -n 'default_autostart_failure_keeps_installation' "$ROOT_DIR/scripts/release_bundle_install_contract_smoke.sh" >/dev/null || fail "release_bundle_missing_default_autostart_failure_contract"
rg -n 'bootstrap_default_autostart_failure_keeps_installation' "$ROOT_DIR/scripts/release_bundle_install_contract_smoke.sh" >/dev/null || fail "release_bundle_missing_bootstrap_default_autostart_failure_contract"
...
rg -n 'CHIMERA_UPDATE_FIRST_CHECKED=1 .*chimera-control\.sh" start' "$ROOT_DIR/scripts/install_desktop_control.sh" >/dev/null || fail "installer_autostart_rechecks_update_source"
