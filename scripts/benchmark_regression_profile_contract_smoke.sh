...
restore() {
  ...
  if [[ -f "$tmp_dir/benchmark_baseline.json" ]]; then
    cp "$tmp_dir/benchmark_baseline.json" docs/benchmark_baseline.json
  fi
...
cp docs/benchmark_baseline.json "$tmp_dir/benchmark_baseline.json"
...
mv docs/benchmark_baseline.json "$tmp_dir/benchmark_baseline.json.missing"
...
mv "$tmp_dir/benchmark_baseline.json.missing" docs/benchmark_baseline.json
