...
fn render_help_text(lang: Language) -> String {
    ...
    match lang {
        Language::En => {
            ...
            out.push_str("  chimera [--lang en|ru] mesh route-announce --namespace <name> --node <name> --destination <cidr/...|domain/...> --via <peer_id> --route-binding-id <n> --peer <node@endpoint#region@load@reliability> [--peer ...] [--ttl <seconds>] [--signature-base64 <b64>] [--multipath-mode <off|flow_shard|standby_only|aggregate_buffered>] [--json]\n");
        ...
        Language::Ru => {
            ...
            out.push_str("  chimera [--lang en|ru] mesh route-announce --namespace <имя> --node <имя> --destination <cidr/...|domain/...> --via <peer_id> --route-binding-id <n> --peer <node@endpoint#region@load@reliability> [--peer ...] [--ttl <секунды>] [--signature-base64 <b64>] [--multipath-mode <off|flow_shard|standby_only|aggregate_buffered>] [--json]\n");
