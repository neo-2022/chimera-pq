...
const MESH_USAGE_EN: &str = "usage: chimera [--lang en|ru] mesh <nodes|contracts|route-explain|route-announce|connect-probe|launch-preflight|launch-preflight-verify> ...";
const MESH_USAGE_RU: &str = "использование: chimera [--lang en|ru] mesh <nodes|contracts|route-explain|route-announce|connect-probe|launch-preflight|launch-preflight-verify> ...";
...
fn render_help_text(lang: Language) -> String {
    ...
    match lang {
        Language::En => {
            ...
            out.push_str("  chimera [--lang en|ru] mesh <route-explain|route-announce|connect-probe|launch-preflight|launch-preflight-verify> --namespace <name> --node <name> (--policy-payload <payload> | --traffic-profile <high_speed_anonymous|privacy_first|speed_first|low_latency_private>) --peer <node@endpoint#region@load@reliability> [--peer ...] [--invite-token <token>] [--failed-node <id>] [--cooldown-node <id>] [--table-max-entries <n>] [--table-max-per-region <n>] [--table-stale-after <ticks>] [--timeout-ms <n>] [--json] [--out <file>]\n");
            out.push_str("  chimera [--lang en|ru] mesh route-announce --namespace <name> --node <name> --destination <cidr/...|domain/...> --via <peer_id> --route-binding-id <n> --peer <node@endpoint#region@load@reliability> [--peer ...] [--ttl <seconds>] [--signature-base64 <b64>] [--multipath-mode <off|flow_shard|standby_only|aggregate_buffered>] [--json] [--out <file>]\n");
        ...
        Language::Ru => {
            ...
            out.push_str("  chimera [--lang en|ru] mesh route-announce --namespace <имя> --node <имя> --destination <cidr/...|domain/...> --via <peer_id> --route-binding-id <n> --peer <node@endpoint#region@load@reliability> [--peer ...] [--ttl <секунды>] [--signature-base64 <b64>] [--multipath-mode <off|flow_shard|standby_only|aggregate_buffered>] [--json] [--out <файл>]\n");
