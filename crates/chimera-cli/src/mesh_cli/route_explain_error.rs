...
pub(crate) fn resolution_hint(action: &str) -> &'static str {
    match action {
        ...
        ACTION_EXPORT_TRANSIT_BINDINGS => RESOLUTION_CHECK_MULTIPATH_ROUTE_BINDING,
...
fn error_stage_action_category(error_stage: &str) -> (&'static str, &'static str) {
    match error_stage {
        ...
        STAGE_TRANSIT_LANE_BINDINGS_EXPORT => (ACTION_EXPORT_TRANSIT_BINDINGS, CATEGORY_PLANNING),
