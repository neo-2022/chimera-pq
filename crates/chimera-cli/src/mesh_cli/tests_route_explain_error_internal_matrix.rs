...
use super::tests_contract_constants::{
    ACTION_EXPORT_TRANSIT_BINDINGS, ACTION_INSPECT_DISCOVERY_INPUT, ACTION_INSPECT_ERROR,
    ACTION_INSPECT_FAILOVER_INPUT, ACTION_INSPECT_HEALTH_INPUTS, ACTION_INSPECT_RUNTIME_BOOTSTRAP,
    BACKOFF_AFTER_FIX, BACKOFF_IMMEDIATE, BACKOFF_SHORT, CATEGORY_HEALTH, CATEGORY_PLANNING,
    CATEGORY_RUNTIME, CATEGORY_UNKNOWN, ERROR_PRESSURE_UNKNOWN, ERROR_SELECTED_NONE,
    RESOLUTION_CHECK_MULTIPATH_ROUTE_BINDING, RESOLUTION_INSPECT_DISCOVERY_RECORDS,
    RESOLUTION_INSPECT_ERROR_DETAILS, RESOLUTION_INSPECT_FAILOVER_EVENT,
    RESOLUTION_INSPECT_HEALTH_STATE, RESOLUTION_INSPECT_RUNTIME_NAMESPACE, RETRIABLE_FALSE,
    RETRIABLE_TRUE, STAGE_DISCOVERY_MERGE, STAGE_FAILOVER_PLAN, STAGE_HEALTH_STATE_UPDATE,
    STAGE_RESELECTION_PLAN, STAGE_RUNTIME_BOOTSTRAP, STAGE_TRANSIT_LANE_BINDINGS_EXPORT,
};
...
fn route_explain_error_json_stage_matrix_contract_is_consistent() {
    ...
    let cases = [
        ...
        Case {
            ...
            expected_action: ACTION_EXPORT_TRANSIT_BINDINGS,
            expected_category: CATEGORY_PLANNING,
            expected_retriable: RETRIABLE_TRUE,
            expected_backoff: BACKOFF_SHORT,
            expected_resolution: RESOLUTION_CHECK_MULTIPATH_ROUTE_BINDING,
        },
        Case {
            stage: "unknown_stage",
