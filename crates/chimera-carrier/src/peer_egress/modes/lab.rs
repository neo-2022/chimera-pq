...
pub fn run_bench(options: Options) -> Result<(), String> {
    ...
    let worker_options = Options {
        ...
        transit_max_frames_per_direction: options.transit_max_frames_per_direction,
        transit_max_bytes_per_direction: options.transit_max_bytes_per_direction,
        transit_idle_timeout_ms: options.transit_idle_timeout_ms,
